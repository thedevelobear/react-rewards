    ...
    return (
      <div style={containerStyle}>
        ...
        <div style={cardStyle}>
          ...
          <Row style={rowStyle}>
            <Col style={colStyle} span={24}>
              <Radio.Group
                defaultValue='reward'
                buttonStyle='solid'
                onChange={this.rewardPunishChange}
              >
          ...
          <ConfigSlider
            title='startVelocity'
            inputValue={startVelocity}
            min={1}
            max={100}
            onChange={this.startVelocityChange}
            disabled={disabled}
          />
          <ConfigSlider
            title='elementCount'
            ...
            min={1}
            max={256}
            onChange={this.elementCountChange}
            disabled={disabled}
          />
          <ConfigSlider
            title='elementSize'
            inputValue={elementSize}
            min={1}
            max={50}
            onChange={this.elementSizeChange}
            disabled={disabled}
          />
        </div>
      </div>
